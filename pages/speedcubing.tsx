		...
		<div>
			...
			<main className="container mt-6 px-4 max-w-3xl mb-24">
				...
				<section className="flex flex-col gap-2 mb-12">
					...
					<NiceLink text="2020 Cubing Time Standards" href="https://docs.google.com/spreadsheets/d/1CXr5srbXTLxGt1xfzHsR7-RW3tz4P3VB-wK4FLoV1Q4/edit#gid=0" />
					<p>
